...
public class SaveTextFamily
{
	...
	SaveTextFamily ( "D:\\NoteSpaceHere\\New Text Document.txt","System" );
	  //	  com.notespace.FileHandler.SaveCardBackgroundColor ( "C:\\Users\\Hp\\Documents\\Your Custom Folder\\GTA.txt","#f2f2f7" );
	  //	  SaveCardBackgroundColor ( "C:\\Users\\Hp\\Documents\\Your Custom Folder\\New Text Document.txt" , "#ffc972" );
	  ...
	  HashMap < String, String > hm = ReturnFamilyHashMap ( );
    ...
    public static void SaveTextFamily ( String filePath , String familyName )
    {

	  HashMap < String, String > hm = new HashMap < String, String > ( );

	  if ( ReturnFamilyHashMap ( ) != null ) {
		hm = ReturnFamilyHashMap ( );
	  }
	  hm.put ( filePath , familyName );
	  Save ( hm );
    ...
    public static String GetTextFamily ( String filePath )
    {
	  HashMap < String, String > mapInFile = new HashMap < String, String > ( );

	  if ( ReturnFamilyHashMap ( ) != null ) {
		mapInFile = ReturnFamilyHashMap ( );
	  }
    ...
    private static void Save ( HashMap < String, String > map )
    {
	  ...
	  try {
		...
		File fileOne = new File ( NoteSpacePathStorage.getNoteSpacePathObj ( ).spacePath + "\\.bin\\" + version + "txtfamily.data" );
    ...
    private static HashMap < String, String > ReturnFamilyHashMap ( )
    {
	  ...
	  if ( NoteSpacePathStorage.getNoteSpacePathObj ( ).spacePath != null ) {
		...
		try {
		    ...
		    File toRead = new File ( NoteSpacePathStorage.getNoteSpacePathObj ( ).spacePath + "\\.bin\\" + version + "txtfamily.data" );

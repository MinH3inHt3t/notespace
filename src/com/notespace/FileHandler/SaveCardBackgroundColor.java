...
public class SaveCardBackgroundColor
{
    ...
    public SaveCardBackgroundColor ( )
    {
    ...
    public static void main ( String[] args )
    {
	  ...
	  SaveCardBackgroundColor ( "D:\\NoteSpaceHere\\Photoshop Shortcut.txt" , "linear-gradient(to right top, #a782e0, #ba7fd9, #cb7dd2, #da7bc9, #e67abf, #ea7abb, #ee7ab8, #f27ab4, #f179b7, #f078b9, #ef77bc, #ee76bf)" );

	  //	  System.out.println ( GetCardBackgroundColor ( "D:\\hell" ) );
    ...
    public static void SaveCardBackgroundColor ( String filePath , String colorHex )
    {
    ...
    public static String GetCardBackgroundColor ( String filePath )
    {
    ...
    private static void Save ( HashMap < String, String > map )
    {
	  ...
	  try {
		...
		File fileOne = new File ( NoteSpacePathStorage.getNoteSpacePathObj ( ).spacePath + "\\.bin\\" + version + "bgcolor.data" );
    ...
    private static HashMap < String, String > ReturnColorHashMap ( )
    {
	  ...
	  if ( NoteSpacePathStorage.getNoteSpacePathObj ( ).spacePath != null ) {
		...
		try {
		    ...
		    File toRead = new File ( NoteSpacePathStorage.getNoteSpacePathObj ( ).spacePath + "\\.bin\\" + version + "bgcolor.data" );

package com.notespace.Minimalist.FileNameDialog.FileNameDialogWithText;
...
public class FileNameDialogWithText implements Initializable {
    @FXML
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        noteTextArea.getStyleClass().add("borderBlue");
    ...
    public void makeOriginalUI() {
        ...
        fileNameTextField.getStyleClass().add("borderBlue");
        noteTextArea.getStyleClass().remove("borderRed");
        noteTextArea.getStyleClass().add("borderBlue");
